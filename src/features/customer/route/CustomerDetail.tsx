...
const InfoRow = ({
  ...
  return (
    <div className="grid grid-cols-2 lg:gap-2 gap-8 mb-3">
      <div className="lg:text-sm text-xs font-semibold  lg:w-[100px]  ">
        {label}
      </div>
  ...
  return (
    <div className="w-full lg:px-6 lg:py-4  space-y-4 ">
      ...
      <Card className=" rounded-md">
        ...
        <div className="h-px bg-border w-full p-0" />
        <div className="grid grid-cols-2 lg:gap-x-12  lg:px-6 lg:py-3 p-3">
          <div className="space-y-2">
            ...
            <InfoRow
              label="Account Owner"
              value={companyDetails?.accountOwnerName}
            />
          ...
          <div className="space-y-2 ml-3">
            ...
            <InfoRow
              ...
              value={companyDetails?.industryDescription}
            />
            <InfoRow
              label="Support Owner"
              value={companyDetails?.supportOwnerName}
            />
          </div>
        </div>
      </Card>
